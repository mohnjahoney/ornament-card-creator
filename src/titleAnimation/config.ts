...
const rightAssemblyApproachPoint = new THREE.Vector3(0, 1.4 * ornamentRadius, assemblyZ);
...
const capAssemblyApproachPoint = new THREE.Vector3(0, 2 * ornamentRadius, assemblyZ);

const capFinalPoint = new THREE.Vector3(0, 0.96 * ornamentRadius, assemblyZ);
